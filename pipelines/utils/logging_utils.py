"""
Utilitários para logging e formatação de mensagens
"""
...
def format_log_message(message: str, emoji: str = "📝", **kwargs) -> str:
    ...
    Args:
        ...
        emoji: Emoji para identificação visual
...
def create_execution_summary(
    ...
    """
    Cria sumário da execução do pipeline.
    ...
    Returns:
        Dicionário com sumário da execução
    """
...
def pretty_print_json(data: Dict, logger) -> None:
    ...
    try:
        ...
        logger.warning(f"Não foi possível formatar JSON: {e}")
